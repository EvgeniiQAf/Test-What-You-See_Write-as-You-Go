...
## 🔌 Додавання власних інтеграцій (Custom TMS)

Якщо ви хочете підключити власну систему управління тестуванням (Jira, TestRail тощо) або змінити тип тестів за замовчуванням (Playwright / WebDriverIO), перегляньте наш детальний посібник розробника:
* **[Як додати власну TMS інтеграцію у TWYS](file:///Users/stayinformed/TWYS/Test-What-You-See.-Write-as-You-Go./HOW_TO_ADD_NEW_TMS.md)**
